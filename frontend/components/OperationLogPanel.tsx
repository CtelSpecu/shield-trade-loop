// Updated by Hamiltion23 at 2025-11-06 15:08
// Updated by Hamiltion23 at 2025-11-04 14:50
...
export function OperationLogPanel() {
  ...
  const renderIcon = (type: string) => {
    const cls = "w-4 h-4";
    if (type === "offer_create") return <IconClipboardList className={cls} />;
  ...
  return (
    <div className="card bg-base-100 shadow border w-full max-w-full overflow-hidden">
      <div className="card-body p-4">
        ...
        <div className="text-xs text-base-content/60 mb-2">Offer creation and decryption records</div>
